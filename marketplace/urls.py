...
urlpatterns = [
    ...
    path('repositories/<int:repository_id>/cart/', views.cart_add, name='cart_add'),
    path('api/cart/', views.cart_api, name='cart_api'),
    path('api/cart/<int:repository_id>/', views.cart_item_api, name='cart_item_api'),
    path('api/cart/clear/', views.cart_clear_api, name='cart_clear_api'),
